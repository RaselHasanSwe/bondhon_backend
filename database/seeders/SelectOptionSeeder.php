...
class SelectOptionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Nationality ───────────────────────────────────────────────
        foreach ([
            ['bangladeshi','Bangladeshi'], ['indian','Indian'], ['pakistani','Pakistani'],
            ['sri_lankan','Sri Lankan'], ['nepali','Nepali'], ['british','British'],
            ['american','American'], ['canadian','Canadian'], ['australian','Australian'],
            ['german','German'], ['french','French'], ['italian','Italian'], ['other','Other'],
        ] as $n => [$v, $l]) {
        ...
        $in = $i(['group_key'=>'country','value'=>'india','label'=>'India',
                   'metadata'=>['iso'=>'IN','dial'=>'+91'],'sort_order'=>2]);
        $pk = $i(['group_key'=>'country','value'=>'pakistan','label'=>'Pakistan',
                   'metadata'=>['iso'=>'PK','dial'=>'+92'],'sort_order'=>3]);

        foreach ([
            ['united_kingdom','United Kingdom','GB','+44',4],
            ['united_states','United States','US','+1',5],
            ['canada','Canada','CA','+1',6],
            ['australia','Australia','AU','+61',7],
            ['germany','Germany','DE','+49',8],
            ['france','France','FR','+33',9],
            ['italy','Italy','IT','+39',10],
            ['spain','Spain','ES','+34',11],
            ['netherlands','Netherlands','NL','+31',12],
            ['sweden','Sweden','SE','+46',13],
            ['norway','Norway','NO','+47',14],
            ['denmark','Denmark','DK','+45',15],
            ['finland','Finland','FI','+358',16],
            ['switzerland','Switzerland','CH','+41',17],
            ['austria','Austria','AT','+43',18],
            ['belgium','Belgium','BE','+32',19],
            ['portugal','Portugal','PT','+351',20],
            ['greece','Greece','GR','+30',21],
            ['uae','UAE (United Arab Emirates)','AE','+971',22],
            ['saudi_arabia','Saudi Arabia','SA','+966',23],
            ['qatar','Qatar','QA','+974',24],
            ['kuwait','Kuwait','KW','+965',25],
            ['oman','Oman','OM','+968',26],
            ['bahrain','Bahrain','BH','+973',27],
            ['malaysia','Malaysia','MY','+60',28],
            ['singapore','Singapore','SG','+65',29],
            ['japan','Japan','JP','+81',30],
            ['south_korea','South Korea','KR','+82',31],
            ['china','China','CN','+86',32],
            ['sri_lanka','Sri Lanka','LK','+94',33],
            ['nepal','Nepal','NP','+977',34],
            ['new_zealand','New Zealand','NZ','+64',35],
            ['south_africa','South Africa','ZA','+27',36],
            ['other','Other',null,null,37],
