    ...
    public function run(): void
    {
        $pages = [
            ...
            [
                ...
                'slug'             => 'privacy_policy',
                'content'          => '<h2>Privacy Policy</h2><p><strong>Last updated: May 2026</strong></p><p>Enorsia is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information.</p><h3>1. Information We Collect</h3><p>We collect information you provide during registration (name, email, gender), profile information (age, location, religion, education), photos you upload, and usage data.</p><h3>2. How We Use Your Information</h3><p>We use your information to: provide and improve our services, show relevant matches, send notifications, and communicate with you about your account.</p><h3>3. Information Sharing</h3><p>We do not sell your personal information. Your contact details are only shared with other users according to your privacy settings.</p><h3>4. Data Security</h3><p>We implement industry-standard security measures to protect your personal information from unauthorized access or disclosure.</p><h3>5. Your Rights</h3><p>You have the right to access, update, or delete your personal information. Contact us at privacy@Enorsia.com for data requests.</p><h3>6. Cookies</h3><p>We use cookies to improve your experience. You can control cookie settings in your browser.</p><h3>7. Contact</h3><p>For privacy concerns, contact us at privacy@Enorsia.com.</p>',
                'meta_title'       => 'Privacy Policy — Enorsia Matrimony',
                'meta_description' => 'Read Enorsia\'s Privacy Policy to understand how we collect, use, and protect your personal information.',
                'is_published'     => true,
                'sort_order'       => 5,
            ],
            [
