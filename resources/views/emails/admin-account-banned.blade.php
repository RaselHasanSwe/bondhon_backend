...
@section('content')
    <style>
        .ban-headline { color: #3D2C1E; font-family: 'Georgia', serif; font-size: 26px; font-weight: 700; line-height: 1.3; margin-bottom: 6px; }
        .ban-headline span { color: #B91C1C; }
        .ban-body-text { color: #5A3E2B; font-family: Arial, sans-serif; font-size: 15px; line-height: 1.8; margin-bottom: 16px; }
        .reason-box { background: #FEF2F2; border: 1px solid #FECACA; border-left: 4px solid #DC2626; border-radius: 4px; margin: 24px 0; padding: 18px 20px; }
        .reason-label { color: #991B1B; font-family: Arial, sans-serif; font-size: 11px; font-weight: 700; letter-spacing: 2px; margin-bottom: 8px; text-transform: uppercase; }
    ...
    <div class="info-box">
        <p>If you believe this action was taken in error, please contact our support team at <strong>{{ $contactEmail }}</strong>.</p>
    </div>
@endsection
